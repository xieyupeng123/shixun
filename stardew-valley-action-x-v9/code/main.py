...
class Game:
    def __init__(self):
        ...
        # Create level immediately
        loaded_data = None
        self.level = Level(self.current_map_id, player=None,
    ...
    def show_victory_screen(self):
        ...
        self.screen.blit(et, et.get_rect(
            center=(WIDTH // 2, HEIGHT // 2 + 60)))
        rs = self.font_menu.render(
            'Press R to Play Again', True, (255, 255, 255))
        self.screen.blit(rs, rs.get_rect(
    ...
    def _draw_save_dialog(self):
        ...
        pygame.draw.rect(shadow, (0, 0, 0, 80),
                         shadow.get_rect(), border_radius=24)
        ...
        t2 = fo.render(
            'Press C to Continue or N for New Game', True, (255, 255, 0))
