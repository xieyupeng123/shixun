...
class Game:
    def __init__(self):
        ...
        # game state: start / game / death / victory
    ...
    def show_start_screen(self):
        ...
        # Controls
        ctrl1 = self.font_small.render(
            'WASD: Move  |  SPACE/Click: Attack  |  Q/Wheel: Switch Weapon',
            True, (150, 150, 150))
        r = ctrl1.get_rect(center=(WIDTH // 2, HEIGHT - 70))
        self.screen.blit(ctrl1, r)
    ...
    def show_victory_screen(self):
        ...
        restart = self.font_menu.render(
            'Press R to Restart', True, (255, 255, 255))
        r = restart.get_rect(center=(WIDTH // 2, HEIGHT // 2 + 70))
        self.screen.blit(restart, r)
        ...
        while True:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.MOUSEWHEEL:
                    if self.game_state == 'game' and self.level:
